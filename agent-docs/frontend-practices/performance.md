...
[Code Splitting Example Code](../../agent-reference/frontend/src/app/router.tsx)
...
[Data Prefetching Example Code](../../agent-reference/frontend/src/features/discussions/components/discussions-list.tsx)
