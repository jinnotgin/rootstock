...
[API Errors Notification Example Code](../../agent-reference/frontend/src/lib/api-client.ts)
...
[Error Boundary Example Code](../../agent-reference/frontend/src/app/routes/app/discussions/discussion.tsx)
