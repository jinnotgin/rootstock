...
[API Client Example Code](../../agent-reference/frontend/src/lib/api-client.ts)
...
[API Request Declarations - Query - Example Code](../../agent-reference/frontend/src/features/discussions/api/get-discussions.ts)
[API Request Declarations - Mutation - Example Code](../../agent-reference/frontend/src/features/discussions/api/create-discussion.ts)
